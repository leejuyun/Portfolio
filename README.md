...
> - 시연 영상2 : [https://github.com/user-attachments/assets/bacd55d1-8a23-4ed1-a629-dc2ffa39aaa3](https://github.com/user-attachments/assets/607813fe-db5e-4130-8dac-4984b51a958d)
...
> - 인원 : 1인
> - 역할 : 기능 설계 및 구현 및 유지보수
> - 기능 소개 : 셀에서 사용자가 범위를 선택한 후 상/하/좌/우 방향으로 드래그 시 범위 내 데이터 패턴을 분석하여 새로 확장된 범위 내 데이터를 채웁니다. 
> - 개발 내용 : 범위 내 데이터 패턴 분석 로직, 데이터 계산 및 저장 로직 및 커멘드 구현
> - 시연 영상 : https://github.com/user-attachments/assets/6c700399-24a9-45cc-9683-0cd9605e3120
